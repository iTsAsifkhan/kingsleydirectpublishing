  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Copy editing is the technical pass. The copy editor corrects grammar, punctuation, and spelling, and enforces consistency — of spelling choices (UK vs. US), character names, timelines, capitalisation, and formatting. They apply a style guide so the whole book behaves the same way throughout.',
