    ...
    subServices: [
      {
        ...
        longDescription: 'Our book writing service connects you with an experienced writer who transforms your concept into a complete, professionally written manuscript. From memoirs and business books to fiction and self-help, we cover every genre and writing style.\n\nYour dedicated writer collaborates closely with you through every phase, from initial concept mapping to final chapter drafts. We ensure your voice, perspective, and message are preserved throughout, delivering a manuscript that truly represents you.',
      ...
      },
      {
        ...
        features: ['Full-length manuscript (60k to 100k words)', 'Multi-genre expertise', 'Detailed outline approval process', 'Chapter drafts with revision rounds'],
      },
      {
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        shortDescription: 'Capture reader attention with a cinematic book trailer that brings your story\'s atmosphere and themes to life in 60 to 90 seconds.',
        ...
        features: ['60 to 90 second cinematic format', 'Voiceover & licensed music', 'Multi-platform optimization', 'Script & storyboard included'],
      },
      {
